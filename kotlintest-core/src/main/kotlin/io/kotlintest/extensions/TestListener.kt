...
interface TestListener {
  ...
  /**
   * Invoked once for all specs in a suite, when the first spec in that suite is about
   * to be executed.
   */
  fun beforeSuite(suite: Suite): Unit = Unit

  /**
   * Invoked once after all specs in a suite have completed.
   */
  fun afterSuite(suite: Suite): Unit = Unit
